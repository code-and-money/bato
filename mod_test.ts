...
describe("bato", () => {
  describe("without base", () => {
    ...
    describe("objects", () => {
      const buttonOnlyBase = bato( { base: {} } );
      const buttonOnlyVariants = bato( { variants: {} } );
      ...
      const buttonOnlyBaseNull = bato( { base: null } );
    ...
    describe("without defaults", () => {
      ...
      const cases: [ ButtonWithoutDefaultsWithoutBaseProps, string ][] = [
        ...
        [
          { intent: "primary", m: 1, class: "adhoc-class" } as ButtonWithoutDefaultsWithoutBaseProps,
          "button--primary bg-blue-500 text-white border-transparent hover:bg-blue-600 m-1 adhoc-class",
        ],
        [
          { intent: "primary", m: 1, className: "adhoc-classname" } as ButtonWithoutDefaultsWithoutBaseProps,
    ...
    describe("with defaults", () => {
      ...
      const cases: [ ButtonWithoutBaseWithDefaultsProps, string ][] = [
        [
          // @ts-expect-error must be a type error
          undefined,
        ...
        [
          { aCheekyInvalidProp: "lol" } as ButtonWithoutBaseWithDefaultsProps,
          "button font-semibold border rounded button--primary bg-blue-500 text-white border-transparent hover:bg-blue-600 button--enabled cursor-pointer button--medium text-base py-2 px-4 m-0 button--primary-medium uppercase",
        ],
        [
          { intent: "secondary" },
  ...
  describe("with base", () => {
    describe("without defaults", () => {
      ...
      const cases: [ ButtonWithBaseWithoutDefaultsProps, string ][] = [
        ...
        // @ts-expect-error must be a type error
        [ { aCheekyInvalidProp: "lol" }, "button font-semibold border rounded" ],
        [
          { intent: "secondary" },
        ...
        [
          { intent: "primary", class: "adhoc-class" } as ButtonWithBaseWithoutDefaultsProps,
        ...
        [
          { intent: "primary", className: "adhoc-className" } as ButtonWithBaseWithoutDefaultsProps,
    ...
    describe("with defaults", () => {
      ...
      const cases: [ ButtonWithBaseWithDefaultsProps, string ][] = [
        [
          // @ts-expect-error must be a type error
          undefined,
  ...
  describe("hooks", () => {
    describe("onComplete", () => {
      ...
      test("should extend bato", () => {
        const { bato: batoExtended } = assemble( { hooks: { onComplete: onCompleteHandler } } );

        const component = batoExtended( { base: "foo", variants: { intent: { primary: "bar" } } } );
      ...
      test("should extend cx", () => {
        const { cx: cxExtended } = assemble( { hooks: { onComplete: onCompleteHandler } } );
