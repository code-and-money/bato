...
import { assemble, bato, type BatoProps, compose } from "./exports";
import type * as Bato from "./exports";
...
describe("bato", () => {
  describe("without base", () => {
    ...
    describe("without defaults", () => {
      ...
      type ButtonWithoutDefaultsWithoutBaseProps =
        ...
        | BatoProps<typeof buttonWithoutBaseWithoutDefaultsWithClassNameString>
        | BatoProps<typeof buttonWithoutBaseWithoutDefaultsArray>
        | BatoProps<typeof buttonWithoutBaseWithoutDefaultsWithClassNameArray>;
  ...
  describe("composing classes", () => {
    ...
    const card = ({ margin, padding, shadow }: CardProps = {}) => classes(box({ margin, padding }), cardBase({ shadow }));
    ...
    describe("onComplete", () => {
      ...
      test("should extend bato", () => {
        const { bato: batoExtended } = assemble({
          hooks: { onComplete: onCompleteHandler },
        });
